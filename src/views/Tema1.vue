      ...
      .col-lg-10(data-aos="fade-left")
        .bloque-texto-a.color-acento-botones.p-3.p-md-5.mb-5.dir-ltr
          .row.m-0.align-items-center.justify-content-between
            ...
            .col-lg-4.mb-4.mb-lg-0
              figure(data-aos="flip-left")
                img.nW(src="@/assets/curso/t1-i2.svg", alt="imagen decorativa")
    ...
    .corner-box.color-b3.p-4.mb-5.m-custom
      .row.align-items-center
        .col-lg-3
          .wrap-overflow
            figure(data-aos="flip-left")
              img.nW(src="@/assets/curso/t1-nn.png", alt="personaje animado")
        .col-lg-9
          ...
          .tarjeta.bg-white.p-4.w-100.shadow-3.h-100
            .p-4.rounded-3(style="border: 4px solid #FFCF19" ).h-100
                ...
                ul.lista-ul--color
                  ...
                  li.d-flex
                    i.fas.fa-check(style="color:#FFCF19 ")
                    p.mb-0 Delincuencia online
                  li.d-flex
                    i.fas.fa-check(style="color:#FFCF19 ")
                    p.mb-0 Publicidad invasiva
                  li.d-flex
                    i.fas.fa-check(style="color:#FFCF19 ")
                    p.mb-0 Adicciones online
                  li.d-flex
                    i.fas.fa-check(style="color:#FFCF19 ")
